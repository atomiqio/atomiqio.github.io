...
This should not affect your code if you follow the Express 4 documentation of [app.param](/{{ page.lang }}/1x/api.html#app.param), as it makes no mention of the leading colon.
