...
| Method               | Description
|----------------------|--------------------------------------
| [res.download()](/{{ page.lang }}/1x/api.html#res.download)   | Prompt a file to be downloaded.
| [res.end()](/{{ page.lang }}/1x/api.html#res.end)        | End the response process.
| [res.json()](/{{ page.lang }}/1x/api.html#res.json)       | Send a JSON response.
| [res.jsonp()](/{{ page.lang }}/1x/api.html#res.jsonp)      | Send a JSON response with JSONP support.
| [res.redirect()](/{{ page.lang }}/1x/api.html#res.redirect)   | Redirect a request.
| [res.render()](/{{ page.lang }}/1x/api.html#res.render)     | Render a view template.
| [res.send()](/{{ page.lang }}/1x/api.html#res.send)       | Send a response of various types.
| [res.sendFile()](/{{ page.lang }}/1x/api.html#res.sendFile)     | Send a file as an octet stream.
| [res.sendStatus()](/{{ page.lang }}/1x/api.html#res.sendStatus) | Set the response status code and send its string representation as the response body.

<h2 id="app-route">app.route()</h2>

You can create chainable route handlers for a route path by using `app.route()`.
Because the path is specified at a single location, creating modular routes is helpful, as is reducing redundancy and typos. For more information about routes, see: [Router() documentation](/{{ page.lang }}/1x/api.html#router).
