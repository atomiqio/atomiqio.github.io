...
_Middleware_ functions are functions that have access to the [request object](/1x/api.html#req)  (`req`), the [response object](/1x/api.html#res) (`res`), and the next middleware function in the application's request-response cycle. The next middleware function is commonly denoted by a variable named `next`.
...
<div class="callout" id="callout5">HTTP <a href="/en/1x/api.html#res">response</a> argument to the middleware function, called "res" by convention.</div>

<div class="callout" id="callout6">HTTP <a href="/en/1x/api.html#req">request</a> argument to the middleware function, called "req" by convention.</div>
</td></tr>
</table>
